...
task_registry.register("run_urdf_flat", BaseEnv, RunUrdfFlatEnvCfg(), RunUrdfFlatAgentCfg())
task_registry.register("run_urdf_rough", BaseEnv, RunUrdfRoughEnvCfg(), RunUrdfRoughAgentCfg())
